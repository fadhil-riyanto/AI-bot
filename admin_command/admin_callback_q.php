...
$get_help_files = file_get_contents(__DIR__ . '/../json_data/adminmenujson/slangword.json');
$helper = json_decode($get_help_files, true);


$reply = $helper[$adanParse[1]];
$option = array(
    array($telegram->buildInlineKeyBoardButton("kembali", $url = "", $callback_data = '/admin_help_i@fadhil_riyanto_bot'))
);
