...
if (isset($_GET['data'])) {
  ...
  foreach ($tbl as $rb) {
    if (strtolower($_GET['data']) == $rb->apiname) {
      $res[] = $rb->tabel;
    }
  }
} else {
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><?= $apinameeede ?></h6>
                </div>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      foreach ($res as $tbls) {
                        ...
                        <td>' . $tblss->metode . '</td>
                        <td>' . $tblss->param . '</td>
                        <td><a href="' . $envsystem_base . $tblss->linkapi  . '?' . $queryyy . '" class="btn btn-sm btn-primary" target="_blank" rel="noopener noreferrer">try</a></td>
                      </tr>';
                        }
                      }
