		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Key dibutuhkan untuk mengakses dashboard ini!">
						<span class="label-input100">key</span>
						<input class="input100" type="text" name="key" placeholder="Enter Key" autocomplete="off">
