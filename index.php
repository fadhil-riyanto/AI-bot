...
<body class="index-page sidebar-collapse">
  <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="https://www.developers.eu.org/">
          Fadhil's APIs </a>
  ...
  <div class="page-header header-filter clear-filter" data-parallax="true" style="background-image: url('assets/img/pexels-photo-758742-min.jpg');">
    <div class="container">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand">
            <h1>Fadhil's APIs</h1>
            <h3>Only god can stop me | Belajar apapun yg aku suka dan tanpa paksaan.</h3>
          </div>
        </div>
      </div>
      <br />
                  ...
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="#example2" data-toggle="tab">
                            <i class="material-icons">settings</i> #2 Example
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#example3" data-toggle="tab">
                            <i class="material-icons">settings</i> #3 Example
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#example4" data-toggle="tab">
                            <i class="material-icons">settings</i> #4 Example
                          </a>
                        </li>
                      </ul>
                    </div>
  ...
  <script src="assets/js/material-kite8da.js?v=2.0.3" type="text/javascript"></script>
  <script>
